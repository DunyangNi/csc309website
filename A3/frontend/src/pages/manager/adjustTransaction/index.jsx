...
function AdjustTransactionPage() {
  ...
  const fetchTransactionData = async () => {
    try {
      setLoading(true);
      const res = await fetch(`https://csc309website.onrender.com/transactions/${transactionId}`, {
        method: 'GET',
        headers: {
  ...
  const handleUpdateSuspicious = async () => {
    ...
    try {
      const res = await fetch(`https://csc309website.onrender.com/transactions/${transactionId}/suspicious`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('access_token')}`,
  ...
  const handleCreateAdjustment = async () => {
    ...
    try {
      ...
      const res = await fetch('https://csc309website.onrender.com/transactions', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('access_token')}`,
